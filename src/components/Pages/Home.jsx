...
const Home = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>SağTık - Full Stack Geliştirici</title>
        <meta name="description"
          content="Lua tabanlı uygulamalar geliştiriyor ve Discord botları ile ilgileniyorum." />
      ...
      <div className='flex justify-center py-48 text-center'>
        <div>
          <h1 className='font-bold text-4xl sm:text-6xl'>Merhaba Ben <span className='text-sky-500 underline'>Sağ Tık</span></h1>
          <p className='text-gray-400 text-lg sm:text-xl mt-2 p-1'>Full-Stack geliştiriciyim. İzmir da yaşıyorum.<br />16 yaşındayım.</p>
        </div>
      </div>
