...
const Home = () => {
  const projects = [
    { name: "Lisans Sistemi", description: "Discord Botlarınızı Koruyun", url: "https://viaappdc.xyz", language: "react", extraLanguage: "typescript" },
    { name: "Fivem Paketleri", description: "Bir Çok Sunucunun Fivem Paketi", url: "https://pastebin.com.tr", language: "react", extraLanguage: "typescript" },
    { name: "Fivem Botları", description: "Bir Çok Sunucunun Fivem Botu", url: "https://ravendev.xyz", language: "react", extraLanguage: "typescript" },
  ...
  return (
    <div>
      <Helmet>
        <title>SağTık - Projeler</title>
        <meta name="description" content="Sağtık'ın geliştirdiği projeleri inceleyin. Web geliştirme, Discord botları ve daha fazlası." />
